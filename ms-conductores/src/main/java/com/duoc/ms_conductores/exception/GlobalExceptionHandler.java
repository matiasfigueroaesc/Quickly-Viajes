...
public class GlobalExceptionHandler {
    ...
    // Maneja conductor no encontrado → 404
    @ExceptionHandler(ConductorNotFoundException.class)
    public ResponseEntity<ErrorResponse> manejarConductorNoEncontrado(ConductorNotFoundException ex,
                                                                       HttpServletRequest request) {
        log.warn("Conductor no encontrado. Ruta: {} - Mensaje: {}", request.getRequestURI(), ex.getMessage());
