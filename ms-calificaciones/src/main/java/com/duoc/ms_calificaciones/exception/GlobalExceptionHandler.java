...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> manejarCalificacionNoEncontrada(CalificacionNotFoundException ex,
                                                                          HttpServletRequest request) {
        log.warn("Calificación no encontrada. Ruta: {} - Mensaje: {}", request.getRequestURI(), ex.getMessage());
