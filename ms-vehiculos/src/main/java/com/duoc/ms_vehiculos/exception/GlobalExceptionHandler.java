package com.duoc.ms_vehiculos.exception;
...
public class GlobalExceptionHandler {
    ...
    // Maneja vehículo no encontrado → 404
    @ExceptionHandler(VehiculoNotFoundException.class)
    public ResponseEntity<ErrorResponse> manejarVehiculoNoEncontrado(VehiculoNotFoundException ex,
                                                                      HttpServletRequest request) {
        log.warn("Vehículo no encontrado. Ruta: {} - Mensaje: {}", request.getRequestURI(), ex.getMessage());
