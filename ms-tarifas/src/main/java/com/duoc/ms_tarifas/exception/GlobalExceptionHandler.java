...
public class GlobalExceptionHandler {
    ...
    // Maneja tarifa no encontrada → 404
    @ExceptionHandler(TarifaNotFoundException.class)
    public ResponseEntity<ErrorResponse> manejarTarifaNoEncontrada(TarifaNotFoundException ex,
                                                                    HttpServletRequest request) {
        log.warn("Tarifa no encontrada. Ruta: {} - Mensaje: {}", request.getRequestURI(), ex.getMessage());
