...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> manejarIncidenciaNoEncontrada(IncidenciaNotFoundException ex,
                                                                        HttpServletRequest request) {
        log.warn("Incidencia no encontrada. Ruta: {} - Mensaje: {}", request.getRequestURI(), ex.getMessage());
